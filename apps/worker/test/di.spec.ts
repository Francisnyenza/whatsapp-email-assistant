...
describe.skipIf(!built)('dependency injection metadata (compiled output)', () => {
  ...
  const cases: Array<[string, string, number]> = [
    ...
    ['processors/commands.processor.js', 'CommandsProcessor', 22],
    ['processors/notify.processor.js', 'NotifyProcessor', 5],
    ...
    ['services/mailbox-query.service.js', 'MailboxQueryService', 8],
